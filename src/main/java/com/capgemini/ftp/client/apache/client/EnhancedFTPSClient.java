/*
 * Derived from the Apache EnhancedFTPSClient class under the terms of the Apache 2.0
 * License.
 *
 ...
 *
 * @version $Id: EnhancedFTPSClient.java 1489533 2013-06-04 17:49:00Z sebb $
 * @since 2.0
 */
public class EnhancedFTPSClient extends EnhancedFTPClient {
...
//    ftps        990/udp    ftp protocol, control, over TLS/SSL
     ...
     */
    public EnhancedFTPSClient(boolean isImplicit) {
     ...
     */
    public EnhancedFTPSClient(String protocol) {
        this(protocol, false);
    }
     ...
     * @param isImplicit The security mode(Implicit/Explicit).
     */
    public EnhancedFTPSClient(String protocol, boolean isImplicit) {
        super();
     ...
     */
    public EnhancedFTPSClient(boolean isImplicit, SSLContext context) {
        this(DEFAULT_PROTOCOL, isImplicit);
     ...
     * @param context A pre-configured SSL Context
     */
    public EnhancedFTPSClient(SSLContext context) {
        this(false, context);
    }
